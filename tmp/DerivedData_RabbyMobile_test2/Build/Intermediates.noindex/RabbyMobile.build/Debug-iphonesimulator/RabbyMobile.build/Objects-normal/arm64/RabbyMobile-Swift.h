...
#ifndef RABBYMOBILE_SWIFT_H
#define RABBYMOBILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RabbyMobile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11RabbyMobile16BluetoothManager")
...
@interface BluetoothManager (SWIFT_EXTENSION(RabbyMobile)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface BluetoothManager (SWIFT_EXTENSION(RabbyMobile)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC11RabbyMobile16RabbyAppDelegate")
@interface RabbyAppDelegate : NSObject <UIApplicationDelegate>
